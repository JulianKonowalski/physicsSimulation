...
public class CollisionSolver implements  CollisionVisitor {
    ...
    private void particleLineCollision(Particle particle, Line line) {
        ...
        double normalParticleVelocity = Vec2.project(particle.velocity(), normalCollisionAxis).length();
        particle.setVelocity(Vec2.add(particle.velocity(), Vec2.scale(normalCollisionAxis, normalParticleVelocity * -2.0)));
    }
